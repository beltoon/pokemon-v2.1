...
public class PokemonGymImpl implements PokemonGym {
    ...
    public void enteredTheGym(PokemonTrainer player1) {
        ...
        System.out.println("In front of you stands a Gym Leader");
        System.out.println(gymOwner.getBrock().getName() +": Hello stranger, I'm " +gymOwner.getBrock().getName() + " the gym owner of the Oreburgh. Who are you?");
        System.out.println(player1.getName() + ": I'm " + player1.getName() + " and I'm here to challenge you for a battle!");
        System.out.println(gymOwner.getBrock().getName() +": So you are after my badge too, let's fight!!!");
